...
namespace _05_Create_an_XML_document_using_LINQ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // TODO: Replace this with a single LINQ to XML statement
            XElement root = new XElement("winners",
                             from w in winners
                             select new XElement("winner", new XElement("Name", w.Name),
